...
const ringTexts = [
  'Happy Birthday Andrika',//untuk deskripsi planet layer 1
  "to andrika zaltia zalsabilla",//untuk deskripsi planet layer 2
  "♡Wish U All The Best♡",//untuk deskripsi planet layer 3
  "10/02/2026",//untuk deskripsi planet layer 4
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://naufalmaulanarafiq.github.io/assets-velody/songs/A%20Sorrowful%20Reunion.mp3"
  ];
...
function createHintText() {
  ...
  const context = canvas.getContext('2d');
  const fontSize = 50;
  const text = 'Happy Birthday Andrika!';
